            ...
            <form action="" className="border-1 p-4 text-center">
                ...
                <div className="flex flex-col gap-2 text-left">
                    <div className="flex gap-2 p-2 items-center">
                        <label htmlFor="username"  className="p-1 w-[100px]">Username:</label>
                        <input type="text" placeholder="username" className="border-1 p-1" />
                    </div>
                    <div className="flex gap-2 p-2 items-center">
                    ...
                    <div className="flex gap-2 p-2 items-center">
                        <button className="rounded-sm p-2 bg-amber-500 cursor-pointer hover:opacity-90">Signup</button>
                    </div>
                </div>
            </form>
        </div>
